...
const CompanyFinancials = ({ data, loading }) => {
  return loading ? (
    <div className="company-financials">
      ...
      >
        <Skeleton width="2em" height="auto" />
      </span>
      <p className="company-financials__label">
        <Skeleton width="5em" height="auto" />
      </p>
      <div className="company-financials__data-items">
        <div className="company-financials__data-item">
          ...
          <p className="company-financials__data-key">
            <Skeleton width="80%" height="auto" />
          </p>
        </div>
        <div className="company-financials__data-item">
          <span className="company-financials__data-value">
